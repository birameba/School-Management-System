///////////////////////Choosing the student id or the grade for viewing grade of students///////////////////////////////////
...
public class GradeClassView extends JDialog implements ActionListener, KeyListener {
    ...
    public GradeClassView() {
        ...
        pane.add(stid, 0);
        stid.setBounds(80, 35, 120, 38);
        stid.setForeground(Color.BLUE);
        stid.setFont(ft);

        txtstid = new JTextField();
        pane.add(txtstid, 0);
        txtstid.setBounds(197, 35, 130, 36);
        ...
        pane.add(grade, 0);
        grade.setBounds(355, 35, 120, 38);
        grade.setForeground(Color.BLUE);
        grade.setFont(ft);

        gcb = new JComboBox();
        pane.add(gcb);
        gcb.setBounds(490, 35, 190, 38);
        gcb.addItem("");
        gcb.addItem("Nursery");
        gcb.addItem("L.K.G");
        gcb.addItem("U.K.G");
        ...
        pane.add(inform, 0);
        inform.setBounds(140, 75, 700, 38);
        ...
        pane.add(submit);
        submit.setFont(ft);
        submit.setBounds(340, 120, 150, 38);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submit || e.getSource() == txtstid) {
            ...
            switch (c) {
                ...
                case "U.K.G":
                    cl = "ukg";
                    new ClassGradeUKG(cl);
                      this.dispose();
                    break;

                case "L.K.G":
                    cl = "lkg";
                    new ClassGradeLKG(cl);
                      this.dispose();
                    break;

                case "Nursery":
                    cl = "nursery";
                    new ClassGradeNursery(cl);
                      this.dispose();
                    break;
            }
        }
