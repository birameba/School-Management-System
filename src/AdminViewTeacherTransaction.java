...
public class AdminViewTeacherTransaction extends JFrame implements ActionListener, KeyListener,FocusListener {

    JLabel jlapplelogo, jlmenu, jlmonth, jltview;
    JTextField jtsearch;
    JButton btnsearch,btnrefresh, btndelete;
    ...
    public AdminViewTeacherTransaction() {
        add(panel);
        ...
        btnrefresh.setBounds(835, 205, 130, 36);
