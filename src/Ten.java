...
public class Ten extends JDialog implements ActionListener, KeyListener {
    ...
    public Ten() {
        ...
        pane.add(submit, 0);
        submit.setBounds(40, 633, 120, 28);
       ...
       reset = new JButton("Reset",new ImageIcon("images/refresh.png"));
        pane.add(reset, 0);
        reset.setBounds(190, 633, 120, 28);
        ...
        if (e.getSource() == submit) {
            if (txtid.getText().equals("") || cbterm.getSelectedItem().equals("") || txtnep.getText().equals("") || txteng.getText().equals("") || txtscience.getText().equals("") || txtcmath.getText().equals("") || txtoptmath.getText().equals("") || txtsocial.getText().equals("") || txtcomputer.getText().equals("") || txteph.getText().equals("") || tengprac.getText().equals("") || tsciprac.getText().equals("") || tephprac.getText().equals("") || tcomprac.getText().equals("")) {
                ...
                try {
                    ...
                    PreparedStatement pstmt = db.cn.prepareStatement("insert into ten (terminal,Compulsory_Nepali,Compulsory_English,Science,Compulsory_Mathematics,Optional_Mathematics,Social_Studies,Computer,Health_POP_ENV_EDU,English_Practical,Science_Practical,Health_POP_ENV_Practical,Computer_Practical,sid) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
