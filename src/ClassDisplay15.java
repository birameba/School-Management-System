/////////////////////////Displaying the marks of overall students from class 1 to 5////////////////////////////////////// 
...
public class ClassDisplay15 extends JFrame implements ActionListener, KeyListener,FocusListener {
    ...
    public ClassDisplay15(String grade) {
        c = grade;
        add(panel);
        ...
        table.getColumnModel().getColumn(12).setPreferredWidth(33);
    ...
    public void keyReleased(KeyEvent e) {
        if (e.getSource() == txtsortby) {
            try {
                ...
                while (rs.next()) {
                    model.addRow(new Object[]{rs.getInt("sid"), rs.getString("terminal"), rs.getString("English_I"), rs.getString("English_I_Practical"), rs.getString("English_II"), rs.getString("English_II_Practical"), rs.getString("Compulsory_Nepali"), rs.getString("Compulsory_Mathematics"), rs.getString("Science"), rs.getString("Science_Practical"), rs.getString("Social_Studies"), rs.getString("Social_Practical"), rs.getString("G_K"), rs.getString("Moral"), rs.getString("Computer"), rs.getString("Computer_Practical")});
                }
            } catch (Exception ex) {
            }
        }
