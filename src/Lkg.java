/////////////////////////Marks Entry Form of the L.KG Class//////////////////////////////////////////
...
public class Lkg extends JDialog implements ActionListener, KeyListener{

    JLabel id, subjects, gradeimg, drawing, english, conversation, dictation, englishoral, generalstudies, nepali, mathoral, science, math, scienceoral, rhymes, nepalioral, term, total, percentage, logo, division;
    JPanel pane;
    JComboBox cbterm, cbdiv;
    JTextField txtid, txteng, txtengoral, txtneporal, txtdictation, txtconversation, txtscienceoral, txtscience, txtmath, txtmathoral, txtnepali, txtgeneralstudies, txtdraw, txtrhymes, txttotal, txtpercent;
    //int sum,percent,div;
    ...
    public Lkg() {
        ...
        pane.add(reset, 0);
        reset.setBounds(190, 563, 120, 28);
    ...
    public void setEnabled() {
        ...
        txtgeneralstudies.setEnabled(true);
    ...
    public void setDisabled() {
        ...
        txtgeneralstudies.setEnabled(false);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submit) {
            ...
            try {
                ...
                PreparedStatement pstmt = db.cn.prepareStatement("insert into lkg (terminal,English,English_Oral,Nepali,Nepali_Oral,Mathematics,Mathematics_Oral,Science,General_Studies,Rhymes,Drawing,Conversation,Dictation,sid) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
                ...
                pstmt.setDouble(9, Double.parseDouble(txtgeneralstudies.getText()));
                pstmt.setString(10, txtrhymes.getText());
                pstmt.setString(11, txtdraw.getText());
                pstmt.setString(12, txtconversation.getText());
                pstmt.setString(13, txtdictation.getText());
    ...
    public void keyTyped(KeyEvent e) {
        ...
        if (e.getSource() == txtid || e.getSource() == txtnepali || e.getSource() == txtscience || e.getSource() == txtmath || e.getSource() == txteng || e.getSource() == txtgeneralstudies) {
            char c = e.getKeyChar();
    ...
    public void keyReleased(KeyEvent e) {
        ...
        if (e.getSource() == txtgeneralstudies) {
            if (txtgeneralstudies.getText().length() > 5) {
                txtgeneralstudies.setText(txtgeneralstudies.getText().substring(0, 5));
                JOptionPane.showMessageDialog(null, "Maximum Character Reached", "Marks Entering Error !!", JOptionPane.ERROR_MESSAGE);
            }
              else {
                Double dd = Double.parseDouble(txtgeneralstudies.getText());
              check100(dd);
            }
        }
