//////////////////////Called from the View Student and View Marksheet of class 7//////////////////////////////////// 
import java.awt.*;
...
public class SevenDisplay extends JFrame {
    ...
    public SevenDisplay(String grade, int student_id) {
        st = student_id;
        c = grade;
        add(panel);
