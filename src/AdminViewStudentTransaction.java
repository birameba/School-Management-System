...
public class AdminViewStudentTransaction extends JFrame implements ActionListener, KeyListener,  FocusListener {
    ...
    public AdminViewStudentTransaction() {
        ...
        panel.add(jlsort);
        jlsort.setFont(ft);
        jlsort.setBounds(170, 210, 120, 38);

        cbsortby = new JComboBox();
        panel.add(cbsortby);
        cbsortby.setBounds(260, 210, 200, 35);
        cbsortby.addItem("");
