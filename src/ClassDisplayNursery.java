/////////////////////////Displaying the marks of overall students from class NURSERY////////////////////////////////////// 
...
public class ClassDisplayNursery extends JFrame implements ActionListener, KeyListener, FocusListener {
    ...
    public ClassDisplayNursery(String grade) {
        c = grade;
        add(panel);
...
new ClassDisplayNursery("Nursery");
    }
