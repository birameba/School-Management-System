//////////////Called for changing the password for the account section/////////////////////////////// 
...
public class ChangeAccount extends JFrame implements ActionListener, MouseListener, KeyListener {

    JLabel jlold,lblBack, jlnew, jlrenew;
    JButton jbupdate;
    ...
    public ChangeAccount() {
        ...
        add(jppass,0).setBounds(203, 95, 200, 35);
        jppass.setFont(ft1);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == jbupdate || e.getSource() == jpold  || e.getSource() == jppass || e.getSource() == jprenew) {
            try {
                ...
                while (rs.next()) {
                    String pass = rs.getString("account");
                    if (passen(jpold.getText()).equals(pass) && jppass.getText().equals(jprenew.getText())) {
                        st1 = dbc.cn.prepareStatement("update login set account=?");
