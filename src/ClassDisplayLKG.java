/////////////////////////Displaying the marks of overall students from class LKG////////////////////////////////////// 
...
public class ClassDisplayLKG extends JFrame implements ActionListener, KeyListener, FocusListener{
    ...
    public ClassDisplayLKG(String grade) {
        c = grade;
        add(panel);
    ...
    public void DisplayData() {
        try {
            ...
            while (rs.next()) {
                model.addRow(new Object[]{rs.getInt("sid"), rs.getString("terminal"), rs.getString("English"), rs.getString("English_Oral"), rs.getString("Nepali"), rs.getString("Nepali_Oral"), rs.getString("Mathematics"), rs.getString("Mathematics_Oral"),rs.getString("Science"), rs.getString("General_Studies"), rs.getString("Rhymes"), rs.getString("Drawing"), rs.getString("Conversation"), rs.getString("Dictation")});
            }
