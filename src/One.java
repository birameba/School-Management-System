...
public class One extends JDialog implements ActionListener, KeyListener{

    JLabel id, subjects, gradeimg, nepali, english1, sciprac, socialprac, moral, draw, dictation, moralprac, comprac, eng1prac, eng2prac, english2, science, computer, social, gk, drawingdiet, math, term, total, percentage, logo, division;
    JPanel pane;
    JComboBox cbterm, cbdiv;
    JTextField txtid, txtnep, txteng1, txteng2, txtsocial, tgk, tsciprac, tmoral, tsocialprac, txtdraw, txtdictation, tgkprac, tmoralprac, tcomprac, teng1prac, teng2prac, txtcomputer, txtscience, txtdrawingdiet, txtmath, txttotal, txtpercent;
    //int sum,percent,div;
        ...
        if (e.getSource() == submit) {
            if (txtid.getText().equals("") || cbterm.getSelectedItem().equals("") || txtnep.getText().equals("") || txteng1.getText().equals("") || txteng2.getText().equals("") || txtscience.getText().equals("") || txtmath.getText().equals("") || txtsocial.getText().equals("") || txtcomputer.getText().equals("") || tmoral.getText().equals("") || teng2prac.getText().equals("") || teng1prac.getText().equals("") || tsciprac.getText().equals("") || tsocialprac.getText().equals("") || tcomprac.getText().equals("") || tgk.getText().equals("")) {
                ...
                try {
                    ...
                    PreparedStatement pstmt = db.cn.prepareStatement("insert into one (terminal,English_I,English_II,Compulsory_Nepali,Science,Compulsory_Mathematics,Social_Studies,Computer,G_K,Moral,English_I_Practical,English_II_Practical,Science_Practical,Social_Practical,Computer_Practical,Drawing,Dictation,sid) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
