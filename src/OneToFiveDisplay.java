//////////////////////Called from the View Student and View Marksheet of class 1 and 5//////////////////////////////////// 
import java.awt.*;
...
public class OneToFiveDisplay extends JFrame {
    ...
    public OneToFiveDisplay(String grade,int student_id) {
        st = student_id;
        c=grade;
        add(panel);
