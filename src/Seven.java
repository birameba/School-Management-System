...
public class Seven extends JDialog implements ActionListener, KeyListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == submit) {
            if (txtid.getText().equals("") || cbterm.getSelectedItem().equals("") || txtnep.getText().equals("") || txteng1.getText().equals("") || txteng2.getText().equals("") || txtscience.getText().equals("") || tvocprac.getText().equals("") || txtcmath.getText().equals("") || txtoptmath.getText().equals("") || txtsocial.getText().equals("") || txtcomputer.getText().equals("") || txtvocation.getText().equals("") || teng2prac.getText().equals("") || teng1prac.getText().equals("") || tsciprac.getText().equals("") || tsocialprac.getText().equals("") || tcomprac.getText().equals("") || tgk.getText().equals("")) {
                ...
                try {
                    ...
                    pstmt.setDouble(17, Double.parseDouble(txtoptmath.getText()));
    ...
    public void keyTyped(KeyEvent e) {
        if (e.getSource() == txteng1 || e.getSource() == txteng2 || e.getSource() == txtid || e.getSource() == txtoptmath || e.getSource() == txtnep || e.getSource() == txtscience || e.getSource() == txtcmath || e.getSource() == txtsocial || e.getSource() == txtcomputer || e.getSource() == tgk || e.getSource() == txtvocation || e.getSource() == teng1prac || e.getSource() == tsciprac || e.getSource() == teng2prac || e.getSource() == tcomprac || e.getSource() == tsocialprac || e.getSource() == tvocprac) {
            char c = e.getKeyChar();
