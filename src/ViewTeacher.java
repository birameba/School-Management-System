...
public class ViewTeacher extends JFrame implements ActionListener, KeyListener,FocusListener {
    ...
    public ViewTeacher() {
        ...
        panel.add(sortby);
        sortby.setFont(ft);
        sortby.setBounds(50, 213, 120, 40);

        cbsortby = new JComboBox();
        panel.add(cbsortby);
        cbsortby.setBounds(140, 213, 160, 35);
        cbsortby.addItem("");
        ...
        panel.add(txtsortby);
        txtsortby.setBounds(350, 213, 260, 40);
        ...
        btnedit.setBounds(653, 213, 130, 38);
        ...
        btndelete.setBounds(823, 213, 130, 38);
        ...
        btnrefresh.setBounds(983, 213, 130, 38);
       ...
       if (e.getSource() == cbsortby) {
        ...
        if (e.getSource() == btndelete) {
            if (!table.isRowSelected(table.getSelectedRow())) {
                JOptionPane.showMessageDialog(null, "Please select teacher to delete record !!","Deleting Information Error",JOptionPane.ERROR_MESSAGE);
            }try {
                pstmt = dbc.cn.prepareStatement("delete from teacher where teacher_id=?");
        ...
        if (e.getSource() == btnedit) {
            if (!table.isRowSelected(table.getSelectedRow())) {
                JOptionPane.showMessageDialog(null, "Please select teacher data to edit !!","Editing Information Error",JOptionPane.ERROR_MESSAGE);
            }else{
                int tid = Integer.parseInt(model.getValueAt(table.getSelectedRow(), 0).toString());
            EditTeacherTable ns = new EditTeacherTable(tid);
            this.dispose();
        }
        }
