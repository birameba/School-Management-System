...
public class ViewGradeNursery extends JFrame {
    ...
    public ViewGradeNursery(String grade, int id) {
        c = grade;
        stid = id;
        add(panel);
   ...
   table.getColumnModel().getColumn(7).setPreferredWidth(50);
    ...
    public static void main(String[] args) {
        try {
           ...
           //new ViewGradeNursery("Nursery",11);
    }
