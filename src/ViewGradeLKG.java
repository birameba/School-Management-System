...
public class ViewGradeLKG extends JFrame {
    ...
    public ViewGradeLKG(String grade, int id) {
        c = grade;
        stid = id;
        add(panel);
...
//        new ViewGradeLKG("lkg",120);
    ...
    public String GettingGPA(double zz){
      ...
      DecimalFormat dec = new DecimalFormat("0.00");
          percent= Double.parseDouble(dec.format((zz / 12.0)));
       if (percent >= 3.6) {
            finalgrade = "A+";
