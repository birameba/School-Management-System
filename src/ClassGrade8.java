...
public class ClassGrade8 extends JFrame {
    ...
    public ClassGrade8(String grade) {
        c = grade;
   ...
   table.getColumnModel().getColumn(7).setPreferredWidth(50);
    ...
    public static void main(String[] args) {
        ...
        new ClassGrade8("Eight");
    }
 public void getData(){
     try {
         model.setRowCount(0);
         stmt=db.cn.createStatement();
         rs=stmt.executeQuery("SELECT e.terminal,(e.computer_practical+e.computer) AS computer,(e.english_practical+e.compulsory_english) AS english, (e.science_practical+e.science) AS science,(e.social_practical+e.social_studies) AS social,e.compulsory_nepali AS nepali,e.compulsory_mathematics AS maths,e.vocation_and_occupation AS vocation,e.optional_mathematics AS opt,e.health as health,r.student_id,r.fname,r.mname,r.lname,r.class,r.roll_no FROM eight e JOIN record r ON e.sid=r.student_id ");
            while(rs.next()){
