...
public class ViewGrade6 extends JFrame {
    ...
    public ViewGrade6(String grade, int id) {
        c = grade;
        stid = id;
        add(panel);
...
//        new ViewGrade6("Six",131);
    ...
    public void getData(){
     try {
         ...
         pstmt=db.cn.prepareStatement("SELECT e.terminal,(e.english_I_practical+e.english_I) AS eng1,(e.english_II_practical+e.english_II) AS eng2, (e.computer_practical+e.computer) AS computer, (e.science_practical+e.science) AS science,(e.social_practical+e.social_studies) AS social,e.compulsory_nepali AS nepali,e.compulsory_mathematics AS maths,(e.vocation_practical+e.vocation) AS vocation,e.moral AS moral,r.student_id,r.fname,r.mname,r.lname,r.class,r.roll_no FROM six e JOIN record r ON e.sid=r.student_id WHERE e.sid= ?"); 
         pstmt.setInt(1, stid);
