...
public class ClassGrade15 extends JFrame {
    ...
    public ClassGrade15(String grade) {
        c = grade;
        add(panel);
   ...
   table.getColumnModel().getColumn(7).setPreferredWidth(50);
    ...
    public void getData(){
     try {
         ...
         rs=stmt.executeQuery("SELECT e.terminal,(e.english_I_practical+e.english_I) AS eng1,(e.english_II_practical+e.english_II) AS eng2, (e.computer_practical+e.computer) AS computer, (e.science_practical+e.science) AS science,(e.social_practical+e.social_studies) AS social,e.compulsory_nepali AS nepali,e.compulsory_mathematics AS maths,e.g_k AS gk,e.drawing AS draw,e.dictation AS dictation,e.moral AS moral,r.student_id,r.fname,r.mname,r.lname,r.class,r.roll_no FROM five e JOIN record r ON e.sid=r.student_id ");        
            while(rs.next()){
