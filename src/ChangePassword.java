///////////////////////////Changing the password of the administration section////////////////////////////////////////////
...
public class ChangePassword extends JFrame implements ActionListener, MouseListener, KeyListener {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    if (passen(jpold.getText()).equals(pass) && jppass.getText().equals(jprenew.getText())) {
                        st1 = dbc.cn.prepareStatement("update login set password=?");
