/////////////////////////Displaying the marks of overall students from class 7//////////////////////////////////////
...
public class ClassDisplay7 extends JFrame implements ActionListener, KeyListener, FocusListener {
    ...
    public ClassDisplay7(String grade) {
        c = grade;
        add(panel);
        ...
        model.addColumn("<html>Optional<br> Mathematics</html>");
    ...
    public void keyReleased(KeyEvent e) {
        if (e.getSource() == txtsortby) {
            try {
                ...
                while (rs.next()) {
                    model.addRow(new Object[]{rs.getInt("sid"), rs.getString("terminal"), rs.getString("English_I"), rs.getString("English_I_Practical"), rs.getString("English_II"), rs.getString("English_II_Practical"), rs.getString("Compulsory_Nepali"), rs.getString("Compulsory_Mathematics"), rs.getString("Science"), rs.getString("Science_Practical"), rs.getString("Social_Studies"), rs.getString("Social_Practical"), rs.getString("G_K"), rs.getString("Vocation"), rs.getString("Vocation_Practical"), rs.getString("Computer"), rs.getString("Computer_Practical")});
                }
            } catch (Exception ex) {
            }
        }
