...
public class ViewGrade extends JFrame {
    ...
    public ViewGrade(String grade, int id) {
        c = grade;
        stid = id;
        add(panel);
   ...
   table.getColumnModel().getColumn(7).setPreferredWidth(50);
    ...
    public void getData(){
     try {
         ...
         pstmt=db.cn.prepareStatement("SELECT n.terminal,(n.english_practical+n.compulsory_english) AS eng,(n.computer_practical+computer) AS comp,(n.science_practical+n.science) AS science,(n.health_pop_env_practical+n.health_pop_env_edu) AS health,n.compulsory_nepali AS nepali,n.compulsory_mathematics AS maths,n.social_studies AS social,n.optional_mathematics AS opt ,r.student_id,r.fname,r.mname,r.lname,r.class,r.roll_no FROM " + c + " n JOIN record r ON n.sid=r.student_id WHERE n.sid= ?"); 
         pstmt.setInt(1, stid);
